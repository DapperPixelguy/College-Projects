...
def calculate_final_costs(daily_cost, vax):
    ...
    print(f"It is estimated that food for this dog will cost £{est_monthly_food:.2f} per month ")

    print(f"It is estimated that food for this dog will cost £{est_yearly_food:.2f} per year ")

    print(f"It is estimated that total cost for this dog (including vaccination) will be £{total_inc_vax:.2f} per year ")
